...
const VIDEO_SOURCES: Record<string, string> = {
  "Makurdi Border North Sensor":
    "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4",
  "Gboko Checkpoint Sensor":
    "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/SubaruOutbackOnStreetAndDirt.mp4",
  "Otukpo Border East Sensor":
    "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/Sintel.mp4",
  "Katsina-Ala West Sensor":
    "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/VolkswagenGTIReview.mp4",
  "Vandeikya South Sensor":
        ...
        const yolov7 = await tf.loadGraphModel(
          "./yolov7tiny_web_model/model.json", // Assume model in public folder
          {
            onProgress: (fractions) =>
              console.log(`Loading: ${fractions * 100}%`),
          }
        );
        ...
        <div className="w-96 bg-slate-800 border-l border-slate-700 p-4 overflow-y-auto">
          ...
          <div className="mb-4 space-y-2">
            ...
            <select
              ...
              onChange={(e) =>
                setSelectedThreatType(e.target.value as ThreatType | "all")
              }
